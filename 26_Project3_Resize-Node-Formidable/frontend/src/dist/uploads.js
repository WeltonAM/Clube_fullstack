...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/components/uploads.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!*************************************!*\
  !*** ./node_modules/axios/index.js ***!
  \*************************************/
/*! exports provided: default, Axios, AxiosError, CanceledError, isCancel, CancelToken, VERSION, all, Cancel, isAxiosError, spread, toFormData, AxiosHeaders, formToJSON, mergeConfig */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _helpers_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/http */ "./src/helpers/http.js");
  ...
  return {
    ...
    choose: function choose() {
      ...
      reader.onload = function (e) {
        var imagePreview = _this.$refs.img;
        imagePreview.width = 350;
        imagePreview.height = 250;
        imagePreview.src = e.target.result;
        _this.showButtonUpload = true;
      };
      reader.readAsDataURL(imageData);
    },
    upload: function () {
      var _upload = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
        var _this2 = this;
        var _file$files, file, formData, _yield$http$post, data, _error$response;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(((_file$files = file.files) === null || _file$files === void 0 ? void 0 : _file$files.length) <= 0)) {
                  _context.next = 7;
                  break;
                }
              ...
              case 7:
                ...
                _context.next = 11;
                return _helpers_http__WEBPACK_IMPORTED_MODULE_3__["default"].post("/image", formData);
              case 11:
              ...
              case 17:
                ...
                this.message = (_error$response = _context.t0.response) === null || _error$response === void 0 ? void 0 : _error$response.data;
                setTimeout(function () {
                  _this2.message = "";
                }, 3000);
              case 21:
